...
class GoodsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // exit;
        // 加载商品列表页面
        return view('Admin.Goods.good',['goods'=>$goods,'request'=>$request->all()]);
    }
    ...
    public function create()
    {
        ...
        return view('Admin.Goods.good-add',['type'=>$type]);
    }
    ...
    public function store(AdminGoodinsert $request)
    {
        ...
        if(Goods::create($data)){
            ...
            return redirect("/good/create")->with('error','数据添加失败');
        }
    }
    ...
    public function show(Request $request,$id)
    {
        ...
        // dd($good->name);
        return view('Admin.Goods.good-size',['info'=>$info,'good'=>$good]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.Goods.good-edit',['type'=>$type,'good'=>$good,'type_id'=>$good->type_id]);
    ...
    public function update(AdminGoodedit $request, $id)
    {
        ...
        if($request->hasFile('pic')){
            ...
            if(Goods::where('id','=',$id)->update($data)){
                ...
                return redirect("/good/create")->with('error','数据修改失败');
            }
        }else{
    ...
    public function sizeadd(Request $request,$id){
        return view('Admin.Goods.size-add',['id'=>$id]);
    }
    //执行商品添加
    ...
    public function sizeedit(Request $request,$id){
        ...
        // dd($data);
        return view('Admin.Goods.size-edit',['data'=>$data]);
    }
