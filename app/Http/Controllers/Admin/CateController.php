...
class CateController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       //DB::raw() 插入原生的sql语句 防止sql注入
        ...
        return view('Admin.Cate.cate',['cate'=>$cate,'request'=>$request->all()]);
    }
    ...
    public function create()
    {
        ...
        // dd($cate);
        // 分类添加页面
        return view('Admin.Cate.cate-add',['cate'=>$cate]);
    }
    ...
    public function edit($id)
    {
        ...
        // dd($data);
        // 分类修改
        return view('Admin.Cate.cate-edit',['cate'=>$cate,'data'=>$data,'class'=>$class,'pid'=>$cate->pid]);
    }
